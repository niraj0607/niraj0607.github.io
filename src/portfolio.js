...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Backennd Engineer with experience in working on most of the latest tech stack"),
    emoji(
      "⚡ Computer Science enthusiast with a zest to explore and learn each day !"
    )
  ],
